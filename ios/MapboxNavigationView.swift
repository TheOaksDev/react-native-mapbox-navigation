...
class MapboxNavigationView: UIView, NavigationViewControllerDelegate, NavigationServiceDelegate {
  ...
  func navigationViewController(_ navigationViewController: NavigationViewController, didAdd speedLimitView: SpeedLimitView) {
      // Adjust the position of the SpeedLimitView
      print("navigationViewController didAdd SpeedLimitView")
      speedLimitView.frame.origin = CGPoint(x: 300, y: 20) // Set your desired X and Y position here
  }
  ...
  func navigationService(_ service: NavigationService, didUpdate progress: RouteProgress, with location: CLLocation, rawLocation: CLLocation) {
      ...
      self.navViewController?.navigationService(service, didUpdate: progress, with: location, rawLocation: rawLocation)
  }
  ...
  func navigationService(_ service: NavigationService, didPassSpokenInstructionPoint instruction: SpokenInstruction, routeProgress: RouteProgress) {
      ...
      self.navViewController?.navigationService(service, didPassSpokenInstructionPoint: instruction, routeProgress: routeProgress)
  }
  ...
  func navigationService(_ service: NavigationService, willRerouteFrom location: CLLocation?) {
      ...
      self.navViewController?.navigationService(service, willRerouteFrom: location!)
  }
  ...
  func navigationService(_ service: NavigationService, didRerouteAlong route: Route, at location: CLLocation?, proactive: Bool) {
      ...
      self.navViewController?.navigationService(service, didRerouteAlong: route, at: location!, proactive: proactive)
